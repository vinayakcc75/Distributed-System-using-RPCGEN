/*
 * This is sample code generated by rpcgen and Modifiied by Vinayak
 */
...
int main (int argc, char *argv[]) {
    ...
    //for operation = pwd
    else if ((result_1 != (outparams *) NULL)&&(strcmp(operation, PWD) == 0)) {
        char cwd[1024];
    ...
    //for operation = cp
    else if ((result_1 != (outparams *) NULL)&&(strcmp(operation, CP) == 0)) {
        ...
        if (files[0] == -1) /* Check if file opened */
            return -1;
        files[1] = open(argv[4], O_WRONLY | O_CREAT | S_IRUSR | S_IWUSR);
